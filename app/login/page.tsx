            ...
            <div className="w-full max-w-sm flex flex-col items-center">
                ...
                <div className="w-full bg-white border border-card-border rounded-2xl p-8 card-shadow">
                    ...
                    <button
                        type="button"
                        onClick={handleLogin}
                        className="w-full flex items-center justify-center gap-3 bg-white border border-card-border text-gray-700 font-bold py-3.5 rounded-xl hover:bg-gray-50 active:scale-[0.98] transition-all text-sm"
                    >
                ...
                <p className="mt-8 text-center text-xs text-gray-400 font-medium">
                    Don't have an account? <a className="text-primary font-bold hover:underline" href="#">Contact Administrator</a>
                </p>
            </div>
        </div>
    );
